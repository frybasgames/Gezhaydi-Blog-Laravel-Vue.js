...
//        $this->middleware('JWT');
    ...
    {
        if(!Cache::has('my-articles')){
//            $articles=Articles::where('user_id',Auth::id())->orderBy('created_at', 'desc')->get();
            ...
            $timeFinished=now()->addMinute(10);
            Cache::put('my-articles',$articles,$timeFinished);

        }else{
            $articles=Cache::get('my-articles');
        }
